...
<img src='images/train-wf.png' width=500>
...
1. In a Python terminal create a GBDX interface and specify the task input location:
    ...
    input_location = 's3://gbd-customer-data/32cbab7a-4307-40c8-bb31-e2de32f940c2/platform-stories/train-cnn-chip-classifier/'
    ```
